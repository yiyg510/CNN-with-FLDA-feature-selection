...
% 
% try
%     Class_Map1 = Salinas_lda_wrapper(params1);
% catch
...
% 
% try 
%     Class_Map2 = Salinas_lda_wrapper(params2);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map2 = 0;
% end
...
% 
% try
%     Class_Map3 = Salinas_lda_wrapper(params3);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map3 = 0;
% end
...
% 
% try
%     Class_Map4 = Salinas_lda_wrapper(params4);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map4 = 0;
% end
...
% 
% try
%     Class_Map5 = Salinas_lda_wrapper(params5);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map5 = 0;
% end
...
% 
% try
%     Class_Map6 = Salinas_lda_wrapper(params6);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map6 = 0;
% end
...
% 
% try
%     Class_Map7 = Salinas_lda_wrapper(params7);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map7 = 0;
% end
...
% 
% try
%     Class_Map8 = Salinas_lda_wrapper(params8);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map8 = 0;
% end
...
% 
% try
%     Class_Map9 = Salinas_lda_wrapper(params9);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map9 = 0;
% end
...
% 
% try
%     Class_Map10 = Salinas_lda_wrapper(params10);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map10 = 0;
% end
...
% 
% try
%     Class_Map11 = Salinas_lda_wrapper(params11);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map11 = 0;
% end
...
% 
% try
%     Class_Map12 = Salinas_lda_wrapper(params12);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map12 = 0;
% end
...
% 
% try
%     Class_Map13 = Salinas_lda_wrapper(params13);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map13 = 0;
% end
...
% 
% try
%     Class_Map14 = Salinas_lda_wrapper(params14);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map14 = 0;
% end
...
% 
% try
%     Class_Map15 = Salinas_lda_wrapper(params15);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map15 = 0;
% end
...
% 
% try
%     Class_Map16 = Salinas_lda_wrapper(params16);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map16 = 0;
% end
...
% 
% try
%     Class_Map17 = Salinas_lda_wrapper(params17);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map17 = 0;
% end
...
% 
% try
%     Class_Map18 = Salinas_lda_wrapper(params18);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map18 = 0;
% end
...
% 
% try
%     Class_Map19 = Salinas_lda_wrapper(params19);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map19 = 0;
% end
...
% 
% try
%     Class_Map20 = Salinas_lda_wrapper(params20);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map20 = 0;
% end
...
% 
% try
%     Class_Map21 = Salinas_lda_wrapper(params21);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map21 = 0;
% end
...
% 
% try
%     Class_Map22 = Salinas_lda_wrapper(params22);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map22 = 0;
% end
...
% 
% try
%     Class_Map23 = Salinas_lda_wrapper(params23);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map23 = 0;
% end
...
% 
% try
%     Class_Map24 = Salinas_lda_wrapper(params24);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map24 = 0;
% end
...
% 
% try
%     Class_Map25 = Salinas_lda_wrapper(params25);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map25 = 0;
% end
...
% 
% try
%     Class_Map26 = Salinas_lda_wrapper(params26);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map26 = 0;
% end
...
% 
% try
%     Class_Map27 = Salinas_lda_wrapper(params27);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map27 = 0;
% end
...
% 
% try
%     Class_Map28 = Salinas_lda_wrapper(params28);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map28 = 0;
% end
...
% 
% try
%     Class_Map29 = Salinas_lda_wrapper(params29);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map29 = 0;
% end
...
% 
% try
%     Class_Map30 = Salinas_lda_wrapper(params30);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map30 = 0;
% end
...
% 
% try
%     Class_Map31 = Salinas_lda_wrapper(params31);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map31 = 0;
% end
...
% 
% try
%     Class_Map32 = Salinas_lda_wrapper(params32);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map32 = 0;
% end
...
% 
% try
%     Class_Map33 = Salinas_lda_wrapper(params33);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map33 = 0;
% end
...
% 
% try
%     Class_Map34 = Salinas_lda_wrapper(params34);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map34 = 0;
% end
...
% 
% try
%     Class_Map35 = Salinas_lda_wrapper(params35);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map35 = 0;
% end
...
% 
% try
%     Class_Map36 = Salinas_lda_wrapper(params36);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map36 = 0;
% end
...
% 
% try
%     Class_Map37 = Salinas_lda_wrapper(params37);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map37 = 0;
% end
...
% 
% try
%     Class_Map38 = Salinas_lda_wrapper(params38);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map38 = 0;
% end
...
% 
% try
%     Class_Map39 = Salinas_lda_wrapper(params39);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map39 = 0;
% end
...
% 
% try
%     Class_Map40 = Salinas_lda_wrapper(params40);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map40 = 0;
% end
...
% 
% try
%     Class_Map41 = Salinas_lda_wrapper(params41);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map41 = 0;
% end
...
% 
% try
%     Class_Map42 = Salinas_lda_wrapper(params42);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map42 = 0;
% end
...
% 
% try
%     Class_Map43 = Salinas_lda_wrapper(params43);
% catch
%     warning('Problem using function.  Assigning a value of 0.');
%     Class_Map43 = 0;
% end
...
try
    Class_Map44 = Salinas_lda_wrapper(params44);
catch
    warning('Problem using function.  Assigning a value of 0.');
    Class_Map44 = 0;
end
...
try
    Class_Map45 = Salinas_lda_wrapper(params45);
catch
    warning('Problem using function.  Assigning a value of 0.');
    Class_Map45 = 0;
end
...
try
    Class_Map46 = Salinas_lda_wrapper(params46);
catch
    warning('Problem using function.  Assigning a value of 0.');
    Class_Map46 = 0;
end
...
try
    Class_Map47 = Salinas_lda_wrapper(params47);
catch
    warning('Problem using function.  Assigning a value of 0.');
    Class_Map47 = 0;
end
...
try
    Class_Map48 = Salinas_lda_wrapper(params48);
catch
    warning('Problem using function.  Assigning a value of 0.');
    Class_Map48 = 0;
end
...
try
    Class_Map49 = Salinas_lda_wrapper(params49);
catch
    warning('Problem using function.  Assigning a value of 0.');
    Class_Map49 = 0;
end
